...
fusion_material = {
    "burn": [
        ["melted_paraffin.png", "decamillennial_stewpot.png"],
        ["ashes_to_ashes.png", "dust_to_dust.png", "secret_cookbook.png"],
    ],
    "bleed": [
        ["arrested_hymn.png", "millarca.png"],
        ["devotion.png", "smokes_and_wires.png", "rusted_muzzle.png"],
    ],
    "tremor": ["nixie_divergence.png", "interlocked_cogs.png", "bell_of_truth.png"],
    "rupture": [
        "talisman_bundle.png",
        "standard-duty_battery.png",
        "thorny_rope_cuffs.png",
    ],
    "poise": [
        ["pendant_of_nostalgia.png", "recollection_of_a_certain_day.png"],
        ["reminiscence.png", "four-leaf_clover.png", "ornamental_horseshoe.png"],
    ],
    "sinking": [
        "headless_portrait.png",
        "midwinter_nightmare.png",
        "tangled_bones.png",
    ],
    "charge": [
        "wrist_guards.png",
        "material_interference_force_field.png",
        "T-18_octagonal_bolt.png",
    ],
}
