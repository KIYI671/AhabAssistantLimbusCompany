...
class Ui_all_team_basic_setting(object):
    def setupUi(self, all_team_basic_setting):
        ...
        self.sell_gift_select.setGeometry(QtCore.QRect(10, 15, 130, 20))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(int(13 / scale_factor))
        font.setBold(True)
        ...
        self.switch_button.setGeometry(QtCore.QRect(180, 15, 161, 22))
        self.switch_button.setObjectName("switch_button")
        self.switch_button_2 = SwitchButton(self.shop_setting)
        self.switch_button_2.setGeometry(QtCore.QRect(360, 15, 181, 22))
        self.switch_button_2.setObjectName("switch_button_2")
    ...
    def retranslateUi(self, all_team_basic_setting):
        ...
        self.sell_gift_select.setText(_translate("all_team_basic_setting", "舍弃/Abandon"))
